...
popdata<-read.table(file.choose(), header=T, sep="") #collection location information
#longitude, latitude!!
...
#which tile is the population on? check pops 5 and 6 for tile13 and pop 8 for tile15
extract(tile16bioclim1, Pop8)
