...
#check pop sig only bio6, lat, PC2, PC3, trt
#pc2
...
###Mass.log###
modeldata<-FrdatSK[!is.na(FrdatSK$Mass.log),]
...
###Harvest.date###
modeldata<-FrdatSK[!is.na(FrdatSK$Harvest.date),]
...
###bolt.bin###
modeldata<-FrdatSK[!is.na(FrdatSK$bolt.bin),]
